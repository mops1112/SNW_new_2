 ...
 * @author yotsathon
 */
public class ViewTable1 extends javax.swing.JPanel implements ActionListener {
    ...
    public ViewTable1() {
        ...
        String[] petStrings = { "site1        ", "site2", "site3", "site4" };
         String[] area = { "area1       ", "area2", "area3", "area4" };
        group.add(new JComboBox(petStrings));
        group.add(new JComboBox(area));
        group.add(dateTime);
